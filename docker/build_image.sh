...
do
    case $arg in
        ...
        -g|--gpu)
          ...
          BASE_IMAGE="nvidia/cuda:11.0-cudnn7-runtime-ubuntu18.04"
          CUDA_VERSION="cu110"
          shift
          ;;
        -bt|--buildtype)
...
then
  ...
  docker build --file Dockerfile.dev -t $DOCKER_TAG --build-arg BUILD_TYPE=$BUILD_TYPE --build-arg BASE_IMAGE=$BASE_IMAGE --build-arg BRANCH_NAME=$BRANCH_NAME --build-arg CUDA_VERSION=$CUDA_VERSION --build-arg MACHINE_TYPE=$MACHINE .
fi
